                    ...
                    <div className="col-md-12">
                        ...
                        <div className="row align-items-center justify-content-center">
                            ...
                            <div className="row custom-cols">
                                ...
                                <div className="col-md-6">
                                    <div className="app-title">
                                        <h6 className="Th6">Department :</h6>
                                        <div>
                                ...
                                <div className="col-md-6">
                                    <div className="app-title">
                                        <h6 className="Th6">FatherName :</h6>
                                        <div>
                                ...
                                <div className="col-md-6">
                                    <div className="app-title">
                                        <h6 className="Th6">MotherName :</h6>
                                        <div className="">
                                ...
                                <div className="col-md-6">
                                    <div className="app-title">
                                        <h6 className="Th6">contactNumber :</h6>
                                        <div>
                                ...
                                <div className="col-md-6">
                                    <div className="app-title">
                                        <h6 className="Th6">fatherContactNumber :</h6>
                                        <div>
