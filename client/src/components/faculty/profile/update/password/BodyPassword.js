        ...
        <div className="container"> {/* Thêm className cho container */}
            <div>
                ...
                <form onSubmit={update} className="form"> {/* Thêm className cho form */}
                    <h1 className="form-title">Update Password</h1> {/* Thêm className cho form-title */}
                    <div className="form-group"> {/* Thêm className cho form-group */}
                    <p className="form-label">New Password</p> {/* Thêm className cho form-label */}
                    ...
                    <div className="form-group"> {/* Thêm className cho form-group */}
                    <p className="form-label">Confirm Password</p> {/* Thêm className cho form-label */}
                    <div className="input-group"> {/* Thêm className cho input-group */}
                        <input
                    ...
                    <div className="button-group"> {/* Thêm className cho button-group */}
                        <button className="submit-button" type="submit">Update</button> {/* Thêm className cho submit-button */}
                        <button
