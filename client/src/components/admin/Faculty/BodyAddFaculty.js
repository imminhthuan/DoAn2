            ...
            <div className="col-md-12">
                <div className="app-title">
                    <ul className="app-breadcrumb breadcrumb">
                        <li className="breadcrumb-item"><a href="#"><b>Bảng Thêm Giáo Viên</b></a></li>
                    </ul>
                    ...
                    <form className="form-content" onSubmit={handleSubmit}>
                        <div className="form-group">
                            <div className="form-field">
                                <h1 className="field-label">Name :</h1>
                                <input
                                    className="input"
                            ...
                            <div className="form-field">
                                <h1 className="field-label">DOB :</h1>
                                <input
                                    className="input"
                        ...
                        <div className="form-group">
                            ...
                            <div className="form-field">
                                <h1 className="field-label">Gender :</h1>
                                <Select
                                    required
                                    displayEmpty
                                    sx={{ height: 36 }}
                        ...
                        <div className="form-group">
                            <div className="form-field">
                                <h1 className="field-label">Contact Number :</h1>
                                <input
                                    required
